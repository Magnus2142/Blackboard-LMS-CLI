...
# import requests
# from bbcli.cli import courses, entry_point
# from bbcli.views.course_view import print_course
...
#    {
#       'id':'_32909_1',
#       'name':'Sammenslått - Ingeniørfaglig systemtenkning INGA2300 INGG2300 INGT2300 (2022 VÅR)'
#    },
#    {
#       'id':'_31606_1',
#       'name':'INGT2300 Ingeniørfaglig systemtenkning (2022 VÅR)'
#    },
#    {
#       'id':'_32736_1',
#       'name':'Sammenslått - Matematiske metoder 3 for dataingeniører IMAX2150 (2021 HØST)'
#    },
#    {
#       'id':'_28936_1',
#       'name':'IMAT2150 Matematiske metoder 3 for dataingeniører (2021 HØST)'
#    },
#    {
#       'id':'_27251_1',
#       'name':'IDATT2900 Bacheloroppgave  (start 2021 HØST)'
#    }
# ]
...
# # TODO: Se over om det kan refaktoriseres bedre, tror det er unødvendig mye funksjoner. Endre om view endrer
...
#     def init_auth_and_get(self):
#         self.mock_auth.return_value.ok = True
#         self.mock_get.return_value.ok = Mock(ok=True)
#         self.mock_get.return_value.text = json.dumps(TEST_COURSE)   

#     def start_terms_and_memberships_mocking(self):
#         self.mock_get_terms = self.mock_get_terms_patcher.start()
#         self.mock_get_memberships = self.mock_get_memberships_patcher.start()

#         self.mock_get_terms.return_value = TEST_TERMS_LIST
#         self.mock_get_memberships.return_value = TEST_COURSE_MEMBERSHIPS_LIST

#     def stop_terms_and_memberships_mocking(self):
#         self.mock_get_terms_patcher.stop()
#         self.mock_get_memberships_patcher.stop()             

#     def test_list_course(self):
#         self.init_auth_and_get()
        
#         runner = CliRunner()
#         result = runner.invoke(entry_point, ['courses', 'list', '--course', '_33050_1'])

#         assert_equal(result.exit_code, 0)

#     def test_list_courses(self):
#         self.init_auth_and_get()
#         self.start_terms_and_memberships_mocking()
        
#         runner = CliRunner()
#         result = runner.invoke(entry_point, ['courses', 'list'])

#         self.stop_terms_and_memberships_mocking()
...
#         runner = CliRunner()
#         result = runner.invoke(entry_point, ['courses', 'list', '--all'])
